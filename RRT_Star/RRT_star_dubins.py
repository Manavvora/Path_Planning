...
class RRT_star_dubins(RRT_star):
    """
    Class for RRT star planning with Dubins path
    """

    class Node(RRT_star.Node):
        """
        RRT Node
        """
    ...
    def calc_new_cost(self, from_node, to_node):
        ...
        _, _, _, _, course_lengths = RRT.dubins.plan_dubins_path(
            from_node.x, from_node.y, from_node.yaw,
            to_node.x, to_node.y, to_node.yaw, self.curvature)
...
def main():
    ...
    RRT_star_dubins = RRT_star_dubins(start, goal, rand_area=[-2.0, 15.0], obstacle_list=obstacleList)
    path = RRT_star_dubins.planning(animation=show_animation)
